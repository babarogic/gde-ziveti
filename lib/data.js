export const PHASES = [
  {
    ...
    locs: {
      ...
      petro:    [['good','Blizu centra, karakter'],['good','Jeftiniji kvadrat'],['neutral','Auto pomaže ali nije neophodan'],['neutral','Mirnije večeri']],
      ...
      zlatibor: [['good','Potpuno novi početak'],['good','Priroda i planina'],['bad','Poslovna izolacija'],['bad','Daleko od porodice/prijatelja']]
    }
  },
  {
  ...
  },
  {
    ...
    locs: {
      ...
      zlatibor: [['good','Život na planini u penziji'],['good','Priroda celo leto'],['good','Turizam = prihodi'],['neutral','Zima može biti izazov']]
    }
  }
];
...
export const LOCATIONS = [
  ...
  {
    id: 'zlatibor', name: 'Zlatibor', tagline: 'Radikalna promena — novi način života',
